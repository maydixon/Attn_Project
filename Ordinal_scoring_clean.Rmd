...
#no differences#
cum_lsmeans<-lsmeans::lsmeans(initial_intO3, "primary_stim")
cum_lsmeans
plot(cum_lsmeans)
```
...
comp_meth <- ggplot(data= t.d.hab., aes(x=Ordinal3, y=all_tw_set, color=primary_stim))
...
comp_treat <- ggplot(data= t.d.hab., aes(x = primary_stim, y = Ordinal3, color=primary_stim))
