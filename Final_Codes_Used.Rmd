...
```{r}
       ...
       #p_de <- p_de + xlab(element_blank())
        p_de<- p_de + labs(title = "D. ebraccatus / 0-chuck P. pustulosus") +
                  theme(plot.title = element_text(face="italic", size=30)) #this makes the plot title italic, affects the size
         p_de <- p_de + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"), axis.text.y=element_blank(), axis.text.x = element_text( size = 30), axis.title.x=element_blank(),
