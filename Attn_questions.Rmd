...
###Now, I want to compare whether the bats habituated to each treatment at a different rate
 ...
 - So, I take it that I want to compare the coefficient of the interaction between call_number and each treatment. I then see whether the coefficients are significantly different. So I can see that (assuming alpha=0.05) the slope of de by callnumber (by looking at the row call_num, bc de is the reference here) is significantly different than the slopes of all of the other interactions:
```{r}
